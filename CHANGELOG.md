...
- **Drop Zone upload-progress UI:** an aggregate progress bar, a Cancel control, a three-bucket (uploaded / skipped / failed) summary, and a Retry that re-sends the real bytes of failed files. (#44)
