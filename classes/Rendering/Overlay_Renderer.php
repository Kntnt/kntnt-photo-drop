...
final readonly class Overlay_Renderer {
	 ...
	 *
	 * @since 0.11.0
	 * @since 0.11.0 The add-to-media icon carries the per-image collection-relative path.
	 *
	 ...
	 *
	 * @since 0.11.0
	 * @since 0.11.0 The add-to-media icon is active and carries the per-image path.
	 * @since 0.11.0 The trash icon is active and carries the per-image path.
	 *
